...
Widget EventPage(EventRegistrationState state, BuildContext context, FeaturedEventModel featuredEvent) {
  return LayoutBuilder( builder: (context, constraints) {
    return Stack(
      alignment: Alignment.topCenter,
      children: [
        MainEventScreen(constraints, context, featuredEvent),
        FloatingTicketingOption(state, context, featuredEvent),
      ],
    );
  },
  );
