...
import '../../../blocs/submit_organiser_form/form_bloc.dart';
import '../../../blocs/submit_organiser_form/form_state.dart';
  ...
  Widget build(BuildContext context) {
    final pages = [
      ...
      commonEntryWidget(
        ...
        description:
            "Choose a name that will give people a clear idea of what the event is about. You can edit this later if you changed your mind.",
        hintText: "Event Name",
      ...
      commonEntryWidget(
        ...
        description:
            "People will see this when we promote your event, but you'll be able to update it later. Your description must meet the community guidelines.",
      ...
      commonEntryWidget(
        ...
        description:
            "Event logos help potential attendees comprehend and remember an event’s name, purpose, and identity more effectively than any other branding tool.\nGive public link from google drive.\nUse image with 1600x840 px.",
      ...
      SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              "Events are held locally, in person and online. We'll connect you with people in your area, and more can join you online. In case of online event the meeting link will be provided 30 minutes prior to the event.",
              style: textStyle(),
            ),
            const SizedBox(
              height: 8,
            ...
            if (mode == EventMode.offline)
              Column(
                ...
                children: [
                  Text(
                    "Tell us about the event location.",
                  ...
                  buildTextField(
                      controller: eventController['location'],
                      hintText: "Location"),
                ],
              ),
            const SizedBox(
            ...
            if (cost == Cost.paid)
              Column(
                ...
                children: [
                  ...
                  buildNumericField(
                      controller: eventController['cost'],
          ...
          children: [
            ...
            Align(
                ...
                child: CommonTextButton(
                    function: () {
                      checkEntriesSubmitForm(organiser, eventController, context, ctrl, isRead, isChecked, mode, cost);
                    },
                    buttonText: 'Submit',
    ...
    return BlocConsumer<SubmitOrganiserFormBloc, SubmitOrganiserFormState>(
        ...
        builder: (context, state) {
          if(state is SubmissionInitial){
            ...
            return const Center(child: Text("Submision success"));
          } else if(state is SubmissionFailed){
            return Scaffold(body: Center(child: Text(state.e),));
          }
          return const Center(child: Text("This shouldn't have happened."));
        }
    );
  }
}
